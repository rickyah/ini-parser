...
//        /// </param>
//        public IniDataParser2(IniParserConfiguration parserConfiguration)
//        {
...
//            IniData iniData = Configuration.CaseInsensitive ? new IniDataCaseInsensitive2() : new IniData();
...
//                    catch (Exception ex)
//                    {
//                        var errorEx = new ParsingException(ex.Message, (uint)lineNumber+1, line, ex);
...
//                "Unknown file format. Couldn't parse the line: '" + currentLine + "'.", 0);
//        }
...
//            {
//                throw new ParsingException("Section name is empty", 0);
//            }
...
//                throw new ParsingException(string.Format("Duplicate section with name '{0}' on line '{1}'", sectionName, line), 0);
//            }
...
//                {
//                    throw new ParsingException("key value pairs must be enclosed in a section", 0);
//                }
...
//            {
//                throw new ParsingException(string.Format("Duplicated key '{0}' found in section '{1}", key, sectionName), 0);
//            }
