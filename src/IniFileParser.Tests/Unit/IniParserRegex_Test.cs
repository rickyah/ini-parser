...
namespace IniFileParser.Tests.Unit
{
    ...
    public class IniParserRegexTest
    {
        ...
        [Test, Ignore("no more regex"), Description("Test a regular expression for matching a comment in an INI file")]
        public void TestCommentRegex()
        {
            ...
            //Assert.That(strGoodTest2, !Does.Match(iniParser.Parser.Configuration.CommentRegex.ToString()));
            //Assert.That(strGoodTest3, !Does.Match(iniParser.Parser.Configuration.CommentRegex.ToString()));
            //Assert.That(strGoodTest4, !Does.Match(iniParser.Parser.Configuration.CommentRegex.ToString()));
        }

        [Test, Ignore("no more regex"), Description("Test a regular expression for matching a section in an INI file")]
        ...
        [Test, Ignore("no more regex"), Description("Test a regular expression for matching a section in an INI file given an specific delimiter")]
